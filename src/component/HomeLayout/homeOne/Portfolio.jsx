...
class Portfolio extends Component{
    render(){
        let title = 'Projects',
        description = 'Code.Sydney is a volunteering organisation that supports beginner developers transition to gain paid employment while helping non-profit and charity organisations with their app needs. Below are some of our projects.';
        return(
            <React.Fragment>
                <div className="portfolio-wrapper">
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <p style={{color:"#F0F0F0"}}>
                                        <a href="https://app.paact.org.au/" target="_blank">Link to project</a>
                                    </p>
                                </div>
                                <br/>
                                <br/>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title">
                                    <h4>Rental Property Extractor App (In aid of searching temporary shelter for the homeless)</h4>
                                    <p>An app to help two Sydney-based charity organisations by providing their back office staff a tool to easily extract potential rental properties as temporary accommodation for those who are on the brink of experiencing homelessness.</p>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title">
                                    <h4>Dr. Lukas Carey, Advocacy on Convict Criminology Website</h4>
                                    <p>Dr. Lukas Carey is a strong advocate for the importance of Convict Criminology and the lived experience to govern the direction of related policies and practices. Code.Sydney is helping Dr. Lukas Carey to boost his online web presence so he can assist more people and organisations alike.</p>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title">
                                    <h4>Deadly Connections Community and Justice Services Limited Legacy Website</h4>
                                    <p>Deadly Connections is a Aboriginal Community Led, Not For Profit Organisation that breaks the cycles of disadvantage and trauma to directly address the over-representation of Aboriginal people in the child protection and justice system/s. Code.Sydney developed the very first website of Deadly Connections.</p>
                                    <p>Project Team: Engramar Bollas</p>
                                    <br/>
                                </div>
                                <div className="col-lg-12">
